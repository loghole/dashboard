...
DOCKER_IMAGE = loghole/dashboard

VERSION  := $(shell git describe --tags --always)
GIT_HASH := $(shell git rev-parse HEAD 2> /dev/null)
BUILD_TS := $(shell date +%FT%T%z)

LDFLAGS:=-X 'github.com/loghole/tron/internal/app.ServiceName=dashboard' \
		 -X 'github.com/loghole/tron/internal/app.AppName=github.com/loghole/dashboard' \
...
run-local:
	go run -ldflags "$(LDFLAGS)" cmd/dashboard/main.go --local-config-enabled
